...
namespace TDBlog.Areas.Admin.Controllers
{
    ...
    public class PageController : Controller
    {
        ...
        public async Task<IActionResult> About()
        {
            ...
            if (page == null)
            {
                // Nếu không tìm thấy trang, tạo mới trang
                page = new Page
                {
                    Slug = "about", // Đặt Slug của trang mới
                    Title = "Default Title", // Đặt tiêu đề mặc định
                                             // Các giá trị khác nếu cần
                };
                _context.Pages!.Add(page); // Thêm trang mới vào DbSet
